-- Qualify the remaining billing receipt counter season_id reference.
-- Function signature, security settings, privileges, and business rules remain unchanged.
...
begin
  ...
  update public.billing_receipt_counters as counter
