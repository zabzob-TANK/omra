...
import { SessionOnglet } from '@/components/admin/session-onglet'
    ...
    <NavGuardProvider>
      <ConfirmProvider>
        <div className="flex min-h-screen flex-col bg-background text-foreground">
          {/* `useSearchParams` impose une frontiere de suspense : sans elle,
              tout l'Administration basculerait en rendu dynamique complet. */}
